...
/**
 * REST controller providing a /rolldice endpoint similar to the Go example.
 * Uses OpenTelemetry for audit logging.
 */
@RestController
public class DiceController {
    ...
    /**
     * Endpoint: /rolldice/{player}
     * Rolls a dice and logs the action using OpenTelemetry.
