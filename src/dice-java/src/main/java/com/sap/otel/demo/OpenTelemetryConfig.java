...
public class OpenTelemetryConfig {
	...
	/**
	 * Configures OpenTelemetry logging with OTLP exporters (gRPC and HTTP) and a stdout exporter.
	 * The service name is set to "audit-java-service".
	...
	public LoggerProvider otelLoggerProvider() {
		...
		LogRecordExporter httpExporter = OtlpHttpLogRecordExporter.builder().setEndpoint(httpEndpoint).build();
