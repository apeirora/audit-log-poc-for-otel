module github.com/apeirora/audit-log-poc-for-otel/recommendation
...
require (
	...
	github.com/open-telemetry/opentelemetry-demo/src/checkout v0.0.0-20250819102904-014194aed8c9
